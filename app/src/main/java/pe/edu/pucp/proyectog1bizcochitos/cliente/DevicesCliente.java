...
public class DevicesCliente extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            case R.id.nav_soli:
                startActivity(new Intent(DevicesCliente.this, SolicitudesCliente.class));
                break;

            case R.id.nav_hist:
                startActivity(new Intent(DevicesCliente.this, HistoryCliente.class));
                break;
            ...
            case R.id.nav_logout:
                ...
                instance.signOut(this).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        startActivity(new Intent(DevicesCliente.this, MainActivity.class));
                        finish();
                    }
                });
                break;
