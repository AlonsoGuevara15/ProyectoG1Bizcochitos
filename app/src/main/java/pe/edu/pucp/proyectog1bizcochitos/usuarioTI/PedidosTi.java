...
public class PedidosTi extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
            ...
            case R.id.nav_logout:
                ...
                instance.signOut(this).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        startActivity(new Intent(PedidosTi.this, MainActivity.class));
                        finish();
                    }
                });
                break;
